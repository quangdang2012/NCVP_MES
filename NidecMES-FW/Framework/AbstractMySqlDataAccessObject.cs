...
{
    public abstract class AbstractMySqlDataAccessObject : DataAccessObject
    {
        /// <summary>
        ...
        //
        /// <summary>
        /// get DefaultMysqlCommandAdaptor
        /// </summary>
        /// <param name="trxContext"></param>
        ...
        protected DbCommandAdaptor GetDbCommandAdaptor(TransactionContext trxContext, String sqlText)
        {
            ...
            DbCommandAdaptor dbCommandAdapter = new DefaultMySqlCommandAdaptor(sqlText, dbConnection);
