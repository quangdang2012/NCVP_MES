...
{
    internal class DefaultMySqlCommandAdaptor : IDisposable, DbCommandAdaptor
    {
        /// <summary>
        /// store idbcommand
        /// </summary>
        ...
        internal DefaultMySqlCommandAdaptor(string sql, IDbConnection dbConnection)
        {//
            this.dbCommand = new MySqlCommand(sql, (MySqlConnection)dbConnection);
        ...
        public DataSet ExecuteDataSet(DbParameterList parameterList)
        {
            ...
            IDbDataAdapter dataadapter = new MySqlDataAdapter((MySqlCommand)dbCommand);
        ...
        {
            return new DefaultMySqlParameterList();
