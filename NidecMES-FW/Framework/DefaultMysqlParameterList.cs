...
{
    partial class DefaultMySqlParameterList : DbParameterList
    {
        ...
        /// </summary>
        private static readonly CommonLogger logger = CommonLogger.GetInstance(typeof(DefaultMySqlParameterList));
        ...
        {
            IDataParameter dataparameter = new MySqlParameter();

            if (name == null)
            {
                MessageData messageData = new MessageData("ffce00039", Properties.Resources.ffce00039, null);
