...
{
    public partial class InspectionItemListForm
    {
        ...
        /// </summary>
        private static readonly CommonLogger logger = CommonLogger.GetInstance(typeof(InspectionItemListForm));
        ...
        /// </summary>
        /// <returns></returns>
        private bool CheckMandatory(bool isFullMandatoryCheck = false)
        {
            ...
            if(!isFullMandatoryCheck) { return true; }

            if (ProcessId_cmb.Text == string.Empty || ProcessId_cmb.SelectedIndex < 0)
            {
        ...
        {
            if (InspectionItem_dgv.Rows.Count > 0 && InspectionItem_dgv.SelectedRows.Count > 0)
            {
                InspectionItemVo inspectionItemVo = (InspectionItemVo)InspectionItem_dgv.Rows[InspectionItem_dgv.CurrentRow.Index].DataBoundItem;
                InspectionItemId = inspectionItemVo.InspectionItemId;
                InspectionItemCode = inspectionItemVo.InspectionItemCode;
                InspectionItemName = inspectionItemVo.InspectionItemName;
            }
            this.Close();
        }
        ...
        private void ItemSearch_btn_Click(object sender, EventArgs e)
        {
            ...
            {
                ItemCode_txt.Text = sapItemSearchVo.SapItemCode;
                ItemName_lbl.Text = sapItemSearchVo.SapItemName;
            }
            else
            {
