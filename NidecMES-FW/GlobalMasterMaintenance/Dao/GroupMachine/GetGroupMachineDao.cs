...
{
    public class GetGroupMachineDao : AbstractDataAccessObject
    {
        public override ValueObject Execute(TransactionContext trxContext, ValueObject vo)
        {
            ...
            sql.Append(@"select b.machine_name, a.registration_user_cd,a.registration_date_time,a.factory_cd
from m_group_machine a
