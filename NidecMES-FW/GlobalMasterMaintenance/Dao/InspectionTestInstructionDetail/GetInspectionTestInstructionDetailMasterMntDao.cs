...
{
    public class GetInspectionTestInstructionDetailMasterMntDao : AbstractDataAccessObject
    {
        public override ValueObject Execute(TransactionContext trxContext, ValueObject arg)
        {
            ...
            {
                sqlQuery.Append(" and itinstd.inspection_test_instruction_id = :inspectiontestinstructionid ");
            }
